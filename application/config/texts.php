...
return array(
    ...
    "FEEDBACK_USERNAME_EMAIL_UPDATE_SUCCESSFUL" => "Username and email updated successfully.",
    "FEEDBACK_USERNAME_EMAIL_UPDATE_FAILED" => "Username and email update failed.",
